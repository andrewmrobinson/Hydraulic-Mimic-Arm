...
# Date: Wed, 22 Aug 2018 05:03:12 GMT
#set_units -time ns
...
create_generated_clock -name {ADC_SAR_1_theACLK} -source [get_pins {ClockBlock/clk_sync}] -edges {1 3 7} [list [get_pins {ClockBlock/aclk_glb_1}]]
...
create_generated_clock -name {ADC_DelSig_1_theACLK} -source [get_pins {ClockBlock/clk_sync}] -edges {1 53 105} -nominal_period 2166.6666666666665 [list [get_pins {ClockBlock/aclk_glb_2}]]
...
# Project: C:\Users\Andrew\Documents\GitHub\Hydraulic-Mimic-Arm\PSOC_arm_project.cydsn\PSOC_arm_project.cyprj
# Date: Wed, 22 Aug 2018 05:03:03 GMT
