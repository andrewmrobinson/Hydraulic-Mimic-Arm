...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	*/
	...
	/* Write the command to the GPIO module. Total 12 bytes including 0x0D  */
	...
	*/
	...
	/* EXAMPLE 3 - READ ADC 01                                                */
	/**************************************************************************
	Write "adc read 01" comamnd to the device and read back response. It is
	...
	while (i<10000)
	{
		...
		*/
		...
		if (pos != std::string::npos) {
			printf("%d = %.*s", i, pos - 12, responseBuffer + 13);
		}
		else {
			printf("%d = %.*s\n", i, 4, responseBuffer + 13);
		}
		i++;
	}
