// ======================================================================
// PSOC_ADC_read.v generated from TopDesign.cysch
// 08/28/2018 at 16:37
...
module ADC_SAR_v3_10_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("5d8085e6-85ab-4659-9926-799d814ca7f5/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__proximal_adc_net;
	wire [0:0] tmpFB_0__proximal_adc_net;
	wire [0:0] tmpIO_0__proximal_adc_net;
	wire [0:0] tmpINTERRUPT_0__proximal_adc_net;
	electrical [0:0] tmpSIOVREF__proximal_adc_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1f112cf5-be9f-40c9-afec-54771b808d74"),
		  ...
		  .input_buffer_sel(2'b00))
		proximal_adc
		 (.oe(tmpOE__proximal_adc_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__proximal_adc_net[0:0]}),
		  .analog({Net_266}),
		  .io({tmpIO_0__proximal_adc_net[0:0]}),
		  .siovref(tmpSIOVREF__proximal_adc_net),
		  .interrupt({tmpINTERRUPT_0__proximal_adc_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__proximal_adc_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__mid_adc_net;
	wire [0:0] tmpFB_0__mid_adc_net;
	wire [0:0] tmpIO_0__mid_adc_net;
	wire [0:0] tmpINTERRUPT_0__mid_adc_net;
	electrical [0:0] tmpSIOVREF__mid_adc_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("14da0b2f-04be-4a80-a456-e1d41f8fcea2"),
		  ...
		  .input_buffer_sel(2'b00))
		mid_adc
		 (.oe(tmpOE__mid_adc_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__mid_adc_net[0:0]}),
		  .analog({Net_274}),
		  .io({tmpIO_0__mid_adc_net[0:0]}),
		  .siovref(tmpSIOVREF__mid_adc_net),
		  .interrupt({tmpINTERRUPT_0__mid_adc_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__mid_adc_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
