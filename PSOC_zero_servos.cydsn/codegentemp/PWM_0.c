...
void PWM_0_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG16(PWM_0_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint16 PWM_0_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG16(PWM_0_CAPTURE_LSB_PTR));
    }
...
void PWM_0_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(PWM_0_PERIOD_LSB_PTR, period);
    #endif /* (PWM_0_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG16(PWM_0_COMPARE1_LSB_PTR, compare);
        #endif /* (PWM_0_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG16(PWM_0_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_0_UsingFixedFunction) */
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_0_UsingFixedFunction)
            return ((uint16)CY_GET_REG16(PWM_0_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG16(PWM_0_COMPARE1_LSB_PTR));
        #endif /* (PWM_0_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG16(PWM_0_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWM_0_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(PWM_0_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG16(PWM_0_PERIOD_LSB_PTR));
    #endif /* (PWM_0_UsingFixedFunction) */
}
